...
function Facebookbot(configuration) {
    ...
    facebook_botkit.createWebhookEndpoints = function(webserver, bot, cb) {
        ...
        webserver.get('/privacy_policy', function(req, res) {
            //res.sendFile( __dirname + "../views/index.html" );
            console.log(__dirname.toString().replace("lib","views\index.html"))
            res.sendFile(__dirname.toString().replace("lib","views\index.html"));
        });
